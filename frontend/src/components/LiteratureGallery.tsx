    ...
    <section className="bg-[#fcfaf5] py-10 md:py-12">
      <div className="w-[90%] md:w-[80%] mx-auto">
        ...
        <div className="md:hidden mb-12">
          ...
          <Link href="/gallery" className="block bg-gray-200 w-full aspect-[4/3] relative overflow-hidden group mb-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <Link href="/gallery" key={i} className="block bg-gray-200 aspect-video relative overflow-hidden group">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          {/* Main Large Image */}
          <Link href="/gallery" className="block md:col-span-2 md:row-span-2 bg-gray-200 aspect-[4/3] md:aspect-auto relative overflow-hidden group">
            <img src="/images/baner1.jpeg" alt="Gallery Image 1" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
               <span className="text-white font-bold border border-white px-4 py-2">View</span>
             </div>
          </Link>
          <Link href="/gallery" className="block bg-gray-200 aspect-video md:aspect-[4/3] relative overflow-hidden group">
